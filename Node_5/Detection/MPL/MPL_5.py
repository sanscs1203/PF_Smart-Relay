...
results_path = 'Results/MLP_detection_5bus_summary.json'
...
{'='*70}
  ...
  │
  ├── Results/
  │   ├── MLP_detection_5bus.pkl          (trained model)
  │   ├── MLP_scaler_5bus.pkl             (StandardScaler - REQUIRED)
  │   ├── MLP_detection_5bus_summary.json (complete config & results)
  ...
  ⚠️  IMPORTANT: For deployment, load BOTH model and scaler:
      model = joblib.load('Results/MLP_detection_5bus.pkl')
      scaler = joblib.load('Results/MLP_scaler_5bus.pkl')
