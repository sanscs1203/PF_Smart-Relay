"""
ieee5/classification/train.py
------------------------------
Trains three candidate models (Random Forest, XGBoost, kNN) for the
multiclass fault-classification module on the IEEE 5-bus network.
...
---------------------------------
    python3 ieee5/classification/train.py --config ieee5/config.yaml
"""
