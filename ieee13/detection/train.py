...
fault-detection module on the IEEE 13-bus network.

Responsibilities
----------------
- Load det_train.csv and det_val.csv via utils.io.load_split().
- Verify scaler.pkl exists via utils.io.verify_scaler().
...
- utils.io.verify_scaler()          : verify scaler.pkl exists
...
def main(config_path: str) -> None:
    ...
    verify_scaler(str(processed_dir / "scaler.pkl"))
